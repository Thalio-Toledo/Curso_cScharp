...
//incluir namespace para o banco SqlSever
...
namespace ACRRentalCar
{
    public partial class frmCadastroCliente : Form
    {
        ...
        private void desabilitar()
        {
            // txtCodigo sempre será desabilitado
            txtCodigo.Enabled = false;
            // altera a propriedade Enable dos controles para ficarem desabilitados
            txtCodigo.Enabled = false;
        ...
        //sub-rotina para limpar os controles de formulario
        ...
        private bool ValidarDados()
        {
            ...
            //Verificar se o que foi digitado em data de nascimento é uma data válida
            DateTime auxData;
            //variavel auxiliar
        ...
        {
            // chama a função para habilitar controles
            habilitar();
        }
