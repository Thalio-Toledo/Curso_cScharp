...
namespace ACRRentalCar
{
    ...
    {
        // declara uma variavel (objeto) do tipo frmCadastrarCliente
        frmCadastroCliente frmCliente; //Variavel da Classe

        //Passando por parametro o form frmCadastroCliente
        //Construtor recebe como paramentro declara uma variavel
        ...
        {
            //Variavel da Classe = parametro do construtor
